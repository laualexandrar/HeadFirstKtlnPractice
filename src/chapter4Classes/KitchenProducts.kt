...
class KitchenProducts (val name: String, val category: String, val quantity: Int,  price_param: Int, taste_param: String){
...
fun main(){
    ...
    println ("my kitchen is full of ${myKitchenProducts.name}, I bought ${myKitchenProducts.quantity} " +
